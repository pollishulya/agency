...
<body>
<div class="modal fade" id="enterModal" style="position: absolute; left: 400px;top:-25px">
    <div class="col">
        ...
        <div class="modal-body">
            <form id="enterForm">
                <div>
                    <p class="title"  style="position:relative; left:0"><spring:message code="confirmRegistration.label"/></p>
                </div>
            </form>
        </div>
    </div>

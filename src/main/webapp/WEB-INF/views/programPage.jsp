...
<div class="modal fade" id="ReserveModal" style="position: absolute; left: 400px;top:400px">
    <div class="col">
        <div>
            ...
            <div class="modal-body">
                <form id="ReserveForm">
                    ...
                    <div id="mistake"></div>
                 <script>alert(program.id)</script>
                    <button class="btn btn-lg btn-primary btn-block" id="reserveBtn"
                            onclick="reserve(${program.id}); return false;"
    ...
    <div class="blog-post">
        <section class="container">
            <div class="panel-body">
                <h1 class="blog-post-title"><p id="tourName">${program.name}</p></h1>
...
<%--                <div><spring:message code="duration"/><b>${food.numberDays}</b></div>--%>
                ...
                <div class='slideshow-container textWrapLeft'>
                    ...
                    <div class='mySlides'>
                        ...
                        <img src='${program.image}/1.jpg' alt='' style='width:100%'>
                    </div>

                    <div class='mySlides'>
                        <div class='numbertext'>2 / 3</div>
                        <img src='${program.image}/2.jpg' style='width:100%'>
                    </div>

                    <div class='mySlides'>
                        <div class='numbertext'>3 / 3</div>
                        <img src='${program.image}/3.jpg' style='width:100%'>
                    </div>
...
<%--                        <div class="panel-body">--%>
                            ...
                            <sec:authorize access="hasRole('ROLE_USER')">
                                <script>
                                    $('#sendButton').append('<button class="btn btn-sm btn-primary pull-right" onclick="saveComment(${program.id})" type="submit"> <i class="fa fa-pencil fa-fw"></i> <spring:message code="send"/> </button>')
                                </script>
                            </sec:authorize>
                            <sec:authorize access="isAnonymous()">
                                <script>
                                    $('#sendButton').append('<span class="d-inline-block" tabindex="0" data-toggle="tooltip" title="<spring:message code="sendCommentError"/>">\n' +
                                        '                                <button class="btn btn-sm btn-primary pull-right" onclick="saveComment(${program.id})" type="submit" disabled> <i class="fa fa-pencil fa-fw"></i> <spring:message code="send"/> </button>\n' +
                                        '                                    </span>')
                                </script>
                            </sec:authorize>
                            <sec:authorize access="hasRole('ROLE_ADMIN')">
                        ...
                        <ul class="pagination justify-content-end">
                            <li class="page-item">
                                <button type="submit" class="btn btn-sm btn-primary" id="previousBtn"
                                        onclick="loadPage=loadPage-1;loadComments(${program.id})"><spring:message
